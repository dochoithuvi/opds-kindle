...
# Version: 0.2.1 FULL Mesquite-origin download fix + global-search
# Author: Kindle OPDS Library prototype
...
case "$HEALTH" in
  *'"version":"0.2.1"'*|*'"version": "0.2.1"'*) : ;;
  *) error "Backend 0.2.1 did not start. Check documents/OPDSLibrary/backend.log." ;;
esac
